...
Latest: **SilkaGlow-House-v116.zip**

Latest draft upload: **SilkaGlow-House-v116.zip** (v113 purchase-only + password membership benefits).
...
- Insider sheet: **share = marketing only, 0 points** (no award on click / return / visibility).
- Earn: SilkaGlow products/subscriptions **strictly over $20** only.
- Join / birthday copy unchanged; redeem/cash rules unchanged.
- Includes House v110 logo balance + GlowMatch CTAs from main (#3).

## Earlier
- v112: store first-paint perf (folded into v113; PR #5 closed as superseded)
- v111: share total-day (superseded by purchase-only)
- v110: logo balance + WhatsApp/Text isolation (#3 on main)
